...
public final class ArrayHelper {
	...
	/*
	 * public static Object[] clone(Class elementClass, Object[] array) { Object[]
	 * result = (Object[]) Array.newInstance( elementClass, array.length );
	...
	/*
	 * public static int countFalse(boolean[] array) { int result=0; for ( int i=0;
	 * i<array.length; i++ ) { if ( !array[i] ) result++; } return result; }
	 */
